...
public class MenuController {
    ...
    public String viewAddItem(Model model, @PathVariable int menuId){
    ...
    public String processAddItem(Model model, @ModelAttribute @Valid AddMenuItemForm form, Errors errors,
        ...
        System.out.println(thisMenu +"New Menu item");
        Cheese addedCheese = cheeseDao.findOne(form.getCheeseId());
        System.out.println(addedCheese +"Cheese Added");
        thisMenu.addItem(addedCheese);
        menuDao.save(thisMenu);
        System.out.println(thisMenu.getId() +"What is this");
